			...
			{mode === 'doctor' ? (
				<div className='grid gap-1.5'>
					...
					<Input
						...
						placeholder={tCommon('login.emailPlaceholder')}
						required
					/>
				</div>
			) : (
				<div className='grid gap-1.5'>
					...
					<Input
						...
						placeholder={tCommon('login.loginPlaceholder')}
						required
					/>
				</div>
			)}
			...
			<div className='grid gap-1.5'>
				...
				<div className='relative'>
					<Input
						...
						placeholder={tCommon('login.passwordPlaceholder')}
						className='pr-10'
						required
					/>
					<button
						...
						aria-label={showPassword ? tCommon('auth.cta.hide') : tCommon('auth.cta.show')}
					>
