...
export interface paths {
    ...
    "/api/v1/public/auth/session": {
        ...
        /** Session */
        get: operations["session_api_v1_public_auth_session_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/doctor/patients/{patient_id}/credentials/reset": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Reset Patient Credentials */
        post: operations["reset_patient_credentials_api_v1_doctor_patients__patient_id__credentials_reset_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/patient/me/credentials": {
        ...
        patch: operations["update_patient_credentials_api_v1_patient_me_credentials_patch"];
        trace?: never;
    };
...
export interface operations {
    ...
    session_api_v1_public_auth_session_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    reset_patient_credentials_api_v1_doctor_patients__patient_id__credentials_reset_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PatientCredentialResetOut"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    update_patient_credentials_api_v1_patient_me_credentials_patch: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PatientCredentialUpdateIn"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PatientCredentialOut"];
                };
            };
            /** @description Validation Error */
            422: {
